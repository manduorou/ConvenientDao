...
public final class ConvenientDaoLog{
    ...
    public static String PTY_TAG;
    private static StringBuffer message;
    static {
        try {
            PTY_TAG = ConfigProperty.getConfigProperty().getDaoTag();
    ...
    public static final void e(Class<?> cls , String meg){
        Log.e(PTY_TAG+MSG_PREFIX,MSG_PREFIX+MSG_ERROR+cls.getName()+ DateUtils.now()+MSG_N+MSG_PREFIX+MSG_N+meg);
    }

    public static final void w(Class<?> cls , String meg){
        Log.w(PTY_TAG+MSG_PREFIX,MSG_PREFIX+MSG_WARN+cls.getName()+ DateUtils.now()+MSG_N+MSG_PREFIX+MSG_N+meg);
    }

    public static final void i(Class<?> cls , String meg){
        Log.i(PTY_TAG+MSG_PREFIX,MSG_PREFIX+MSG_INFO+cls.getName()+ DateUtils.now()+MSG_N+MSG_PREFIX+MSG_N+meg);
    }
